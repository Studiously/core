...
type MultipleChoiceResponse struct {
	...
	ResponseID uuid.UUID `json:"response_id"` // response_id
...
func (mcr *MultipleChoiceResponse) MultipleChoiceQuestion(db XODB) (*MultipleChoiceQuestion, error) {
	return MultipleChoiceQuestionByID(db, mcr.QuestionID)
}
...
func MultipleChoiceResponseByID(db XODB, id uuid.UUID) (*MultipleChoiceResponse, error) {
	var err error
